...
# some paths
parser.add_argument("--eval_file", type=str, default="./data/wider_val_2.txt",
                    help="The path of the validation or test txt file.")

parser.add_argument("--restore_path", type=str, default="./checkpoint/pruned/pruned",
                    help="The path of the weights to restore.")

parser.add_argument("--anchor_path", type=str, default="./data/wider_anchors.txt",
                    help="The path of the anchor txt file.")

parser.add_argument("--class_name_path", type=str, default="./data/wider.names",
